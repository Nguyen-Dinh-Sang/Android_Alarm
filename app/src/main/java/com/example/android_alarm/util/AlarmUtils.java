package com.example.android_alarm.util;
...
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_FRI;
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_IS_ENABLED;
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_LABEL;
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_MON;
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_SAT;
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_SUN;
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_THURS;
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_TIME;
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_TUES;
import static com.example.android_alarm.data.helper.DatabaseHelper.COL_WED;
import static com.example.android_alarm.data.helper.DatabaseHelper._ID;
