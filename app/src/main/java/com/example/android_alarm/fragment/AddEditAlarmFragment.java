...
public final class AddEditAlarmFragment extends Fragment {
    ...
    private void delete() {
        ...
        builder.setTitle("Xác nhận xóa báo thức");
        builder.setMessage("Bạn có chắc chắn muốn xóa báo thức này?");
