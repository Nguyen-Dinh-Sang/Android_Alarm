package com.example.android_alarm.customview;
        ...
        public void onChanged() {
            ...
            if(adapter != null && mEmptyView != null) {
                if(adapter.getItemCount() == 0) {
                    ...
                    com.example.android_alarm.customview.EmptyRecyclerView.this.setVisibility(View.GONE);
                }
                else {
                    mEmptyView.setVisibility(View.GONE);
                    com.example.android_alarm.customview.EmptyRecyclerView.this.setVisibility(View.VISIBLE);
